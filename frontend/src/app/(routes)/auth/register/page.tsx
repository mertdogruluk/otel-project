          ...
          <div className="flex flex-col lg:flex-row min-h-[500px]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white p-8">
                  ...
                  <p className="text-sm lg:text-base text-white/90 leading-relaxed mb-6">
                    ...
                    Hemen kayıt olun ve hayalinizdeki tatili planlayın.
                  </p>
            ...
            <div className="lg:w-3/5 flex items-center justify-center p-8 lg:p-12">
              <div className="w-full max-w-md">
                ...
                {/* Header */}
                <div className="mb-8">
                  <h1 className="text-3xl font-bold font-opensans text-gray-900 mb-2">Hesap Oluştur</h1>
                  <p className="text-gray-600 font-opensans">
                    Zaten hesabınız var mı?{" "}
                    <a href="/auth/login" className="text-blue-600 hover:text-blue-700 font-semibold font-opensans">
                      Giriş Yap
                    </a>
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="firstName" className="font-opensans font-bold text-base text-gray-800">Ad</Label>
                      <Input
                        id="firstName"
                        type="text"
                        placeholder="Adınız"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="lastName" className="font-opensans font-bold text-base text-gray-800">Soyad</Label>
                      <Input
                        id="lastName"
                        type="text"
                  ...
                  {/* Confirm Password */}
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword" className="font-opensans font-bold text-base text-gray-800">Şifre Tekrar</Label>
                    <Input
                      id="confirmPassword"
                      type="password"
                      placeholder="••••••••"
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <Label htmlFor="terms" className="text-sm text-gray-600 leading-relaxed">
                      <span className="font-medium text-gray-900">Kullanım Koşulları</span> ve{" "}
                      <span className="font-medium text-gray-900">Gizlilik Politikası</span>&apos;nı kabul ediyorum
                    </Label>
                  </div>
