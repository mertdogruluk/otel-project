...
const PaymentPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-6">
      ...
      <div className="bg-white rounded-lg shadow mt-8 w-full max-w-3xl overflow-hidden">
        {/* Yatay fotoğraf */}
      ...
      <div className="mb-6 bg-white p-6 rounded-lg shadow flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6 mb-6 w-full max-w-4xl">
