...
const PaymentForm: React.FC = () => {
  return (
    <form className="bg-white p-6 rounded-lg shadow space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="text" className="w-full border border-[rgba(0,0,0,0.2)] rounded p-2" />
        </div>
   ...
   <div>
      ...
      <input type="text" className="w-full border border-[rgba(0,0,0,0.2)] rounded p-2 h-24"  />
   </div>




      <button type="button" className="bg-gray-300 text-gray-800 px-4 py-2 rounded-md mr-2">
        İptal
      </button>
