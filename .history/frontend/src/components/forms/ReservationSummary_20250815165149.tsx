      ...
      <div className="bg-white p-6 rounded-lg shadow space-y-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex flex-col space-y-5 pr-4 ">
            <span className="opacity-50">4 gece</span>
            <span className="opacity-50">Vergiler ve Hizmet Bedeli</span>
          </div>
          <div className="flex flex-col space-y-5 pr-4">
            <span className="text-right">30.000 TL</span>
            <span className="text-right opacity-75">10.500 TL</span>
          </div>
        </div>
      </div>
    </div>
